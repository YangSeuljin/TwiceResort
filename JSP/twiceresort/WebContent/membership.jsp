...
function openConfirmid(inputid){
	//아이디를 입력했는지 검사
	if(inputid.id.value ==""){ //inputid.id.value는 this.form.id.value와 같은 의미이다.
	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" method="get"
			...
			<div class="form-group" id="divName">
				...
				<div class="col-lg-10">
					<input type="text" name="name" class="form-control onlyHangul"
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio"
						...
						id="emailReceiveYn" name="emailReceiveYn" value="N"> 비동의
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio"
						...
						id="smsReceiveYn" name="smsReceiveYn" value="N"> 비동의
					</label>
				</div>
			</div>
			<div class="form-group">
