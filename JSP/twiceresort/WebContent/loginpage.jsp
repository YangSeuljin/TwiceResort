...
<body>
<jsp:include page="Navigation.jsp" flush="false" /> <br>
<!-- Page Content -->
	<div class="container">
...
<form action="loginconfirm.jsp">
    ...
    <div class="container" style="background-color:#f1f1f1">
      <button type="button"class="cancelbtn" onclick="location.href='membership.jsp'">관리자 회원 가입하기</button>
...
<div class="container">
      <label for="uname"><b>아이디</b></label>
      <input type="text" placeholder="아이디를 입력해주세요." name="uname" value="<%=userid%>님 관리자 모드로 로그인 중입니다." readonly>

      <label for="psw"><b>비밀번호</b></label>
      <input type="password" placeholder="비밀번호를 입력해주세요." name="psw" value="**********"readonly>
        <br>
        <label><b></b></label>
        <label><b></b></label>
