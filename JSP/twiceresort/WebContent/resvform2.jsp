...
<div class="w3-card-4">
  ...
  <form name="form" id="form" class="w3-container" action="resvformconfirm.jsp" onsubmit="return f(this)">
    <br>
    <p>      
    <label class="w3-text-brown"><b>성명</b></label>
    <input class="w3-input w3-border w3-sand" name="name" id="name" type="text" placeholder="실제 예약자 성명을 입력해주세요." maxlength="10" required></p>
    <p>      
    <label class="w3-text-brown"><b>예약일자</b></label>
    <input class="w3-input w3-border w3-sand" type="date" name="date" required min="<%=nowdate%>" max="<%=adddate%>"></p>
    <p> 
    <label class="w3-text-brown"><b>예약방</b></label>     
    <select class="w3-text-brown" name="option" id="option">
    ...
    <p>      
    <label class="w3-text-brown"><b>주소</b></label>
     <input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
	신 우편번호 : <input oninput="maxLengthCheck(this) type="number" name="zip_code" id="zip_code" placeholder="우편번호" maxlength="5" required><br>
	구 우편번호 : <input type="text" id="old_zip_code" name="old_zip_code" placeholder="우편번호"  maxlength="7" required><br>
	도로명 주소 : <input type="text" id="roadAddress" name="roadAddress" placeholder="도로명주소" size="40" maxlength="40" required><br>
	지번 주소 : <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번주소" size="40" maxlength="40" required><br>
	</p>
    <p>      
    <label class="w3-text-brown"><b>전화번호</b></label>
    <input class="w3-input w3-border w3-sand" name="phone_number" id="phone_number" type="number" placeholder="- 를 빼고 입력해주세요." maxlength="11" oninput="maxLengthCheck(this)" required></p>
    <p>      
    <label class="w3-text-brown"><b>입금자명</b></label>
    <input class="w3-input w3-border w3-sand" name="iname" id="iname" type="text" placeholder="입금하시는 분의 성명을 입력해주세요." maxlength="10" required></p>
    <p>      
    <label class="w3-text-brown"><b>남기실 말</b></label>
    <input class="w3-input w3-border w3-sand" name="comment" type="text"></p>
    <input type=hidden class="w3-input w3-border w3-sand" name="processing" readonly id="option" value=2>
    <p>
    <input type="submit" value="예약하기" onclick="go();"></p>
  </form>
</div>
