...
<script language="JavaScript">
	...
	function f() {
		...
		var old_zip_code = document.getElementById("old_zip_code");
			...
			<form name="form" id="form" class="w3-container"
				...
				<p>
					<label class="w3-text-brown"><b>성명</b></label> <input
						...
						type="text" placeholder="실제 예약자 성명을 입력해주세요." required>
				</p>
				<p>
					<label class="w3-text-brown"><b>예약일자</b></label> <input
						class="w3-input w3-border w3-sand" readonly name="date"
						value=<%=resv_date%>>
				</p>
				<p>
					<label class="w3-text-brown"><b>예약방</b></label> <input
						class="w3-input w3-border w3-sand" readonly id="option"
						value=<%=roomname%>>
				</p>
				<input type=hidden class="w3-input w3-border w3-sand" name="option"
					readonly id="option" value=<%=introom%>> </select>
				</p>
				<p>
				...
				<p>
					<label class="w3-text-brown"><b>입금자명</b></label> <input
						...
						type="text" placeholder="입금하시는 분의 성명을 입력해주세요." required>
				</p>
				<p>
				...
				new daum.Postcode(
						{
							oncomplete : function(data) {
								...
								var remainRoadAddr = fullRoadAddr.replace(sido
										+ " " + sigungu, "");
								var remainjibunAddr = data.jibunAddress
										.replace(sido + " " + sigungu, "");
