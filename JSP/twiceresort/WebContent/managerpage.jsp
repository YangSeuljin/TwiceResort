...
if(session.getAttribute("userid")==null){
	out.println("<br><br><H2>아이디와 비밀번호를 다시 확인해주세요.</H2>");
	out.println("<button><a href='newindex.jsp'>홈으로 돌아가기</a></button>");
	out.println("<button><a href='loginpage.jsp'>로그인 페이지로 돌아가기</a></button>");
	out.println("<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>");
}
else{
...
<%
	...
	<div class="container">
		...
		<h1 class="mt-4 mb-3"><h1 class="mt-4 mb-3"><%=userid %>님의 관리자 페이지입니다.</h1></h1>
	...
	<div text-align="center">
		<table border="1" width="50%" text-align="center" align="center"
			id="tbs">
			<tr>
				<th width="10%" class="w3-container w3-brown" height="50px">날짜</th>
				<th width="10%" class="w3-container w3-brown">VIP룸
				</td>
				<th width="10%" class="w3-container w3-brown">일반룸
				</td>
				<th width="10%" class="w3-container w3-brown">합리적인 룸
				</td>
				...
				<td width="10%">
					...
					String name = dao2.selectname(strDate,1);
							...
							//out.println(list.get(0));				
								...
								out.println("<a href =d_05.jsp?resv_date=" + strDate
										+ "&room=1&processing=2&date=" + date + "'>"+name+"</a>");
							}
				...
				<td width="10%">
					...
					String name_room2 = dao2.selectname(strDate,2);
							...
							//out.println(list.get(0));				
								...
								out.println("<a href =d_05.jsp?resv_date=" + strDate
										+ "&room=2&processing=2&date=" + date + "'>"+name_room2+"</a>");
							}
					%>
				...
				<td width="10%">
					...
					String name_room3 = dao2.selectname(strDate,3);
							...
							//out.println(list.get(0));				
								...
								out.println("<a href =d_05.jsp?resv_date=" + strDate
										+ "&room=3&processing=2&date=" + date + "'>"+name_room3+"</a>");
							}
					%>
				</td>
			</tr>
