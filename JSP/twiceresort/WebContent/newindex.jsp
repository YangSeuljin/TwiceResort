			...
			<div class="col-lg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<p class="card-text">
							바다위에 우뚝 솟아난 수성화산·유네스코 세계자연유산, 천연기념물 제420호, 올레1코스<br> <br>
			...
			<div class="col-lg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<p class="card-text">
							아름다운 제주 바다속 환상 체험 감동 체험!<br> <br>제주의 에메랄드빛 바다를 온몸으로 느낄
							수 있습니다.<br> <br>연인, 친구 가족과 함께 평생 잊지 못할 행복한 추억을 만들어보세요!
						</p>
					</div>
				</div>
			</div>
