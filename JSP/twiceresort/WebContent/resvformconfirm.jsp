...
int intphone_number= Integer.parseInt(phone_number);

out.println(name);
out.println(date);
out.println(option);
out.println(roadAddress);
out.println(phone_number);
out.println(iname);
out.println(comment);
out.println(now);
out.println(intprocessing);
out.println(intoption);
...
dto.setTelnum(intphone_number); //전화번호
