<!--관리자가 하나의 예약 정보를 확인할 수 있는 페이지입니다.-->
...
<body>
	...
	<div class="container">
		...
		<%
			...
			String telnumber = dao.selecttelnum(resv_date, introom);
		...
		<form name="form" id="form" class="w3-container"
			...
			<div>
				...
				<p>
					...
					<br> <input type="submit" value="수정" formaction="r_update.jsp"
		...
		<button>
			<a href="r_delete.jsp?date=<%=firstDate%>&room=<%=intFirstRoom%>"
